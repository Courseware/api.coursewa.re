...
Rails.application.config.sorcery.configure do |config|
  ...
  config.user_config do |user|
    ...
    # do you want to prevent or allow users that did not activate
    # by email to login?
    # Default: `true`
    #
    ...
    # how long to wait before allowing another email to be sent.
    # Default: `5 * 60`
    #
    ...
    user.authentications_class = Coursewareable::Authentication
