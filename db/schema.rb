...
ActiveRecord::Schema.define(:version => 20130708135533) do
  ...
  create_table "coursewareable_authentications", :force => true do |t|
  ...
  add_index "coursewareable_authentications", ["user_id"], :name => "index_coursewareable_authentications_on_user_id"
